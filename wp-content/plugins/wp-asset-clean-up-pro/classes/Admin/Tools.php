...
SQL;
	...
	public function importDone()
    {
	    ...
	    foreach ($this->data['import_done_list'] as $importedKey) {
            ...
            if ($importedKey === 'tax_type_exceptions') {
                $importedMessage .= '<li>'.esc_html__('Load exceptions for all pages belonging to a specific taxonomy (e.g. all "Categories" from "Posts")', 'wp-asset-clean-up').'</li>';
            }
