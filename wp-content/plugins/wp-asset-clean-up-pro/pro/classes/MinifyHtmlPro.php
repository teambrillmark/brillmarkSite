...
class MinifyHtmlPro
{
	...
	{
		return (false !== strpos($m[1], 'fwp-loop') || false !== strpos($m[1], 'ngg_resource_manager_marker') || 0 === strncmp($m[1],
                '[', 1) || false !== strpos($m[1], '<![') || 0 === strncmp($m[1], 'esi', 3) || 0 === strncmp($m[1],
                'noindex', 7) || 0 === strncmp($m[1], '/noindex', 8) || 0 === strncmp($m[1], 'start_content',
                13) || 0 === strncmp($m[1], 'end_content', 11))
			? $m[0]
			: '';
	}
