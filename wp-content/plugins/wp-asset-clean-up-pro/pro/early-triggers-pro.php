...
SQL;
		...
		// This is to avoid going through most of the array if a post or category page is visited
        // As the match will take place quicker, and extra time and resources are saved
        if (get_option('permalink_structure') === '/%postname%/') {
            $rewrite = array_merge(array('([^/]+)(?:/([0-9]+))?/?$' => 'index.php?name=$matches[1]&page=$matches[2]'), $rewrite);
        }
