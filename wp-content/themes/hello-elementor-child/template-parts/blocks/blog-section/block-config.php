<?php
/**
 * blog-section Block Configuration
 */

if (function_exists('acf_register_block_type')) {
    $block_path = '/template-parts/blocks/blog-section';
    ...
    acf_register_block_type([
        'name'        => 'blog-section',
        'title'       => __('Blog Section', 'textdomain'),
        'description' => __('Blog section with article cards, category badges, and read more button.', 'textdomain'),
