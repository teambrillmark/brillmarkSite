<?php
/**
 * common-case-study-section Block Configuration
 */

if (function_exists('acf_register_block_type')) {
    $block_path = '/template-parts/blocks/common-case-study-section';
    ...
    acf_register_block_type([
        'name'            => 'common-case-study-section',
        'title'           => __('common-case-study-section', 'textdomain'),
        ...
        'enqueue_assets'  => function() use ($dir, $uri) {
            if (file_exists($dir . '/block.css')) {
                wp_enqueue_style(
                    'common-case-study-section-style',
                    $uri . '/block.css',
                    [],
