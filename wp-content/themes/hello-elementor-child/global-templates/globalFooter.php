...
$shape_1       = get_field('shape_1', 'option');
$shape_2       = get_field('shape_2', 'option');
$logo_footer   = get_field('logo_footer', 'option');
$description   = get_field('description', 'option');
$book_link     = get_field('book_meeting_link', 'option');
$book_text     = get_field('book_meeting_button_text', 'option');
$social_links  = get_field('social_links', 'option');
$footer_cols   = get_field('footer_columns', 'option');
$copyright_1   = get_field('copyright_line_1', 'option');
$copyright_2   = get_field('copyright_line_2', 'option');
                    ...
                    <div class="footer-col1">
                        <div class="footer-logo">
                            <?php if (!empty($logo_footer)): ?>
            					<img class="footer-section-logo-img" width="200" height="46" alt="<?php echo esc_attr($logo_footer['alt'] ?? 'Logo'); ?>" src="<?php echo esc_url($logo_footer['url']); ?>" role="img">
                			<?php endif; ?>
                        </div>
